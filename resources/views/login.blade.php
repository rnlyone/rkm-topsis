...
<!-- Mirrored from pixinvent.com/demo/PROFMAT-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-auth-login-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Aug 2021 13:15:15 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width,initial-scale=1.0,user-scalable=0,minimal-ui">
    <meta name="description" content="PROFMAT admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, PROFMAT admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Login Page</title>
    <link rel="apple-touch-icon" href="/app-assets/images/ico/apple-icon-120.html">
    <link rel="shortcut icon" type="image/x-icon" href="https://pixinvent.com/demo/PROFMAT-html-bootstrap-admin-template/app-assets/images/ico/favicon.ico">
    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="#" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ms-1">PROFMAT</h2>
        </a>
